...
When submitting issues it's helpful to provide details of your system setup and status. This can be done by generating a report using http://ems-esp/api?device=system&cmd=info and attaching this to the GithHub issue.
