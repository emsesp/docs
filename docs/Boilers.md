...
| `dhw.settemp`        | `<degrees>`                                 |      | Only if thermostat does not manage it                                              |
...
| `dhw.tapactivated`   | `<off \| on>`                               |      | Special function working in boiler test-mode                                       |
| `dhw.onetime`        | `<off \| on>`                               |      | Overwritten by some thermostats, see thermostat commands                           |
| `dhw.circpump`       | `<off \| on>`                               |      |                                                                                    |
| `dhw.circ`           | `<off \| on>`                               |      | Overwritten by some thermostats, see thermostat commands                           |
| `dhw.circmode`       | `<n>`                                       |      | (1=1x3min, .. 6=6x3min, 7=on)                                                      |
| `dhw.flowtempoffset` | `<degrees>`                                 |      | Offset to boiler temperature while preparing warm water                            |
| `dhw.maxpower`       | `<%>`                                       |      | Maximum power for warm water heating                                               |
