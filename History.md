...
- March 2019 - Version 1.5.0 - Added support for the ESP32

  ![1.5.0](_media/telnet_menu.jpg ':size=400')
...
- September 2019 - Version 1.9.0 - Major release with a new WebUI

  ![1.9.0](_media/ems_dashboard.png ':size=400')
