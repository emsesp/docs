...
| `thermostat_system_data` | data from the Thermostat's system | `{"time":"00:33:38 08/03/2000","dampedtemp":0}` |
| `thermostat_data` | data from each of the Thermostats Heating Circuits. Default HC is 1. The data sent depends on the model. | `{ "hc1":{"seltemp":15,"currtemp":20.6,"mode":"auto"}, "hc2":{"seltemp":8,"currtemp":18.2,"mode":"off"} }` |
| `mixing_data<id>` | data from The Mixing Module for each of the Heating Circuits. | `{"hc1":{"flowTemp":55,"pumpMod":"1","valveStatus":"1"}}` |
